...
class VisitCountries extends Component {
  ...
  renderDisplayCountries = visitedCountry => (
    <div>
      ...
      {visitedCountry.length === 0 ? (
        ...
        <ul className="display-countries-container">
          {visitedCountry.map(eachItem => (
            <DisplayCountries
              eachItem={eachItem}
              key={eachItem.id}
              onClickChangeVisit={this.onClickChangeVisit}
  ...
  render() {
    ...
    return (
      <div className="visit-countries-bg-container">
        <h1 className="visit-countries-heading">Countries</h1>
        {this.renderCountriesList()}
        {this.renderDisplayCountries(visitedCountry)}
      </div>
    )
  }
}
